...
CLEANER_TRANSACTIONS_REPLICAS_Q4 ?= 1

GROUPER_Q2_V2_REPLICAS ?= 1
GROUPER_Q3_V2_REPLICAS ?= 1
GROUPER_Q4_V2_REPLICAS ?= 1

REDUCER_Q2_REPLICAS ?= 1
REDUCER_Q3_REPLICAS ?= 1
REDUCER_Q4_REPLICAS ?= 1

TEMPORAL_FILTER_TRANSACTIONS_REPLICAS ?= 1
TEMPORAL_FILTER_TRANSACTION_ITEMS_REPLICAS ?= 1
AMOUNT_FILTER_TRANSACTIONS_REPLICAS ?= 1

SPLITTER_Q1_REPLICAS ?= 1
SORTER_Q1_V2_REPLICAS ?= 1

JOINER_V2_Q2_REPLICAS ?= 1
JOINER_V2_Q3_REPLICAS ?= 1
JOINER_V2_Q4_REPLICAS ?= 1
